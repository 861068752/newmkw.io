...
function slider(){
    $(window).on('resize',function(){
        ...
        var json = [
            {
                bac:"url(img/banner-1.jpg)",
                img:"img/banner-xs1.jpg"
            },
            {
                bac:"url(img/banner-2.jpg)",
                img:"img/banner-xs2.jpg"
            },
            {
                bac:"url(img/banner-3.jpg)",
                img:"img/banner-xs3.jpg"
            },
            {
                bac:"url(img/banner-4.jpg)",
                img:"img/banner-xs4.jpg"
            }
        ];
